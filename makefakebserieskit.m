...
kit.iterid = 1;
   ...
   % pgoargsin.usespcat = 1;
    ...
    argsin.molstats.kalimit = max([argsin.ka1 argsin.ka2]) + 1;  %change for higher series..
    argsin.molstats.mua = 0;
    argsin.molstats.mub = 1;
...
series1.predictj = findbseriesj(series1.visiblefs);
series1.predictstring = sprintf('suspect j1 = %d, actually %d',series1.predictj,series1.visibleis(1));
kit.fourseriesmode = fourseriesmode;%kit.numlines = numlines;
kit.series1 = series1;
kit.series4 = series4;
...
%   kit.fullerrorstring = sprintf('%s A series: %s\n%s\n%s\n%s',kit.fakemolname,kit.aABCerrorstring,kit.fulla1string,kit.fulla2string,kit.gapstring); 
   ...
   kit.fitlist = {};
   kit.onedpeakhsunassigned = kit.onedpeakhs;
   kit.onedpeakfsunassigned = kit.onedpeakfs;
